...
async function main() {
	...
	try {
		...
		console.log(`Installments marked overdue: ${results.installmentsMarkedOverdue}`);
		console.log(`Agreements completed: ${results.agreementsCompleted}`);
		console.log(`Agreements defaulted: ${results.agreementsDefaulted}`);
