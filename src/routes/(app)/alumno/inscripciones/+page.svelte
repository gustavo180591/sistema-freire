...
<svelte:head>
	<title>Mis materias | ISFD "PAULO FREIRE" 1117</title>
</svelte:head>
...
<div class="mx-auto max-w-7xl space-y-8 p-6">
	...
	<div class="rounded-3xl border border-slate-800 bg-slate-900/70 p-8">
		<div class="flex items-start justify-between">
			<div>
				<p class="text-sm tracking-[0.2em] text-slate-400 uppercase">Trayectoria académica</p>
				<h1 class="mt-2 text-3xl font-bold">Mis materias</h1>
	...
	{#if data.enrollments.length === 0}
		<div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-8 text-center">
			<p class="text-lg text-slate-400">No tenés materias inscriptas</p>
