...
<div class="mx-auto max-w-7xl space-y-8">
	...
	<div class="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
		...
		<a
			href="/usuarios/nuevo"
			class="inline-flex items-center justify-center gap-2 rounded-2xl border-2 border-indigo-600 bg-white px-6 py-3 font-semibold text-indigo-600 transition-all duration-200 hover:scale-[1.02] hover:bg-indigo-50 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-slate-900 focus:outline-none"
							...
							<td colspan="7" class="px-4 py-12">
								<div class="flex flex-col items-center justify-center text-center">
									...
									{#if data.students.length === 0}
										<a
											href="/usuarios/nuevo"
											class="mt-4 inline-flex items-center gap-2 rounded-xl border-2 border-indigo-600 bg-white px-4 py-2 text-sm font-medium text-indigo-600 transition hover:bg-indigo-50 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-slate-900 focus:outline-none"
										>
											<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
												<path
													stroke-linecap="round"
