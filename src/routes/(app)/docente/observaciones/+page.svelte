...
<div class="min-h-screen bg-slate-950 text-white">
	<div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
		<!-- Header -->
		<div class="mb-8">
			<h1 class="mb-2 text-3xl font-bold text-white">Observaciones Académicas</h1>
		...
		<div class="mb-8">
			<div class="rounded-2xl border border-slate-800 bg-slate-900 p-6">
				<h2 class="mb-6 text-xl font-semibold text-white">Nueva Observación</h2>
		...
		<div>
			<h2 class="mb-4 text-xl font-semibold text-white">Observaciones Registradas</h2>
			<div class="space-y-4">
