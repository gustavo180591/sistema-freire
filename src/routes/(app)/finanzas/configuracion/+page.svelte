...
<div class="space-y-8">
	...
	<section class="rounded-3xl border border-slate-800 bg-slate-900/70 p-8">
		...
		<p class="mt-3 max-w-3xl text-sm text-slate-400">
			Configure los montos de cuotas por sede, carrera y tipo de alumno. Defina fechas de
			vencimiento y recargos.
		</p>
	</section>
	...
	<div class="flex gap-4 border-b border-slate-800">
		<button
			...
			class="px-6 py-4 text-sm font-medium transition-colors {activeSede === 'alem'
		...
		<button
			...
			class="px-6 py-4 text-sm font-medium transition-colors {activeSede === 'capiovi'
				? 'border-b-2 border-white text-white'
				: 'text-slate-400 hover:text-slate-300'}"
		>
			Sede Capioví
			...
			{#if activeSede === 'alem'}
						...
						<div>
							...
							<div class="relative">
								...
								<input
									...
									class="w-full rounded-2xl border border-slate-700 bg-slate-950 py-3 pr-4 pl-8 text-white outline-none focus:border-slate-500"
								/>
							</div>
						</div>
						<div>
				...
				<div class="rounded-3xl border border-slate-800 bg-slate-900/70 p-6">
					<h3 class="mb-6 text-lg font-semibold">
						PROFESORADO DE EDUCACIÓN SECUNDARIA EN LENGUA Y LITERATURAs
					</h3>
					<div class="space-y-4">
						<div>
							<label class="mb-2 block text-sm text-slate-400">Alumno Normal</label>
				...
				<div>
					...
					<div class="relative">
						<input
							...
							min="1"
							max="31"
							class="w-full rounded-2xl border border-slate-700 bg-slate-950 px-4 py-3 text-white outline-none focus:border-slate-500"
						/>
						<span class="absolute top-1/2 right-4 -translate-y-1/2 text-slate-500">de cada mes</span
						>
					</div>
				...
				<div>
					...
					<div class="relative">
						<input
							...
							class="w-full rounded-2xl border border-slate-700 bg-slate-950 px-4 py-3 text-white outline-none focus:border-slate-500"
						/>
						<span class="absolute top-1/2 right-4 -translate-y-1/2 text-slate-500">%</span>
					</div>
